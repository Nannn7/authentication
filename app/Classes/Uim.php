...
class Uim
{
     ...
     */
    public function verify(string $userId, string $password): string
    {
     ...
     */
    private function buildPostData(string $userId, string $password): string
    {
     ...
     * @return void
     */
    private function sendHttpRequest($socket, string $postData): void
    {
     ...
     */
    private function decodeHexResponse(string $data): string
    {
        $text  = '';
        $total = strlen($data);
